...
import br.com.alura.forumhub.api.infra.exception.ValidacaoException;
import br.com.alura.forumhub.api.model.Resposta;
import br.com.alura.forumhub.api.model.Usuario;
import br.com.alura.forumhub.api.repository.RespostaRepository;
...
public class RespostaController {
    ...
    public ResponseEntity<Void> deletarResposta(
        ...
        if (!resposta.getAutor().equals(usuarioLogado) && !autorDoTopico.equals(usuarioLogado)) {
